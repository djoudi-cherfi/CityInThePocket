...
const authMW = {
  ...
  auth: async (req, res, next) => {
    try {
      ...
      /* On vérifie et décode le JWT à l'aide du secret et de l'algorithme
      ...
      /* On passe l'utilisateur dans notre requête afin que celui-ci soit disponible
      pour les prochains middlewares */
      req.user = user;
