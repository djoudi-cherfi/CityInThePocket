    ...
    addOne: async (req, res) => {
        ...
        if (!req.body.company_name ||
            ...
            if (dataSiret.header.statut === 200) {
                ...
                const addressTest = `${infoAddress.numeroVoieEtablissement} ${infoAddress.typeVoieEtablissement} ${infoAddress.libelleVoieEtablissement} ${infoAddress.codePostalEtablissement} ${infoAddress.libelleCommuneEtablissement}`;
